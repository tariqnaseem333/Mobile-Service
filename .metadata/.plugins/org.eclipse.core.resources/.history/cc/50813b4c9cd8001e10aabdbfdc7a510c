...
//		will implement this class
	...
	public static void registerRequest(){
		...
		try {
			...
			System.out.println("Service request has been accepted with the request ID: " + obj.getServiceId() + ", status of the request is "
								+ obj.getStatus() + " on " + obj.getTimeOfRequest().format(DateTimeFormatter.ofPattern("dd/MMM/yyyy  hh:mm:ss")));
